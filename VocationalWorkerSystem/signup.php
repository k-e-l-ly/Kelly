    ...
    if(isset($_POST['signup'])){
        ...
        if($lname == "" || $fname == "" || $email == "" || $password == "" || $cpassword == "" ){
            ...
            if($password !== $cpassword){
                ...
                $checkUser = "SELECT * FROM `workers` WHERE `email` = '$email'";
                ...
                if($count){
                    ...
                    $addUser = "INSERT INTO `workers`(`lname`, `fname`, `email`, `password`, `cpassword`) VALUES (NULL,'$lname','$fname','$email','$hash','$hash')";
